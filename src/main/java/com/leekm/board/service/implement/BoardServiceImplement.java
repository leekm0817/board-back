...
import com.leekm.board.dto.request.board.PatchBoardRequestDto;
import com.leekm.board.dto.request.board.PostBoardRequestDto;
import com.leekm.board.dto.request.board.PostCommentRequestDto;
import com.leekm.board.dto.response.ResponseDto;
import com.leekm.board.dto.response.board.BoardListResponseDto;
import com.leekm.board.dto.response.board.CommentListResponseDto;
import com.leekm.board.dto.response.board.DeleteBoardResponseDto;
import com.leekm.board.dto.response.board.FavoriteListResponseDto;
import com.leekm.board.dto.response.board.GetBoardResponseDto;
import com.leekm.board.dto.response.board.GetCommentListResponseDto;
import com.leekm.board.dto.response.board.GetCurrentBoardResponseDto;
import com.leekm.board.dto.response.board.GetFavoriteListResponseDto;
import com.leekm.board.dto.response.board.GetSearchBoardResponseDto;
import com.leekm.board.dto.response.board.GetTop3ResponseDto;
import com.leekm.board.dto.response.board.GetUserListResponseDto;
import com.leekm.board.dto.response.board.PatchBoardResponseDto;
import com.leekm.board.dto.response.board.PostBoardResponseDto;
import com.leekm.board.dto.response.board.PostCommentResponseDto;
import com.leekm.board.dto.response.board.PutFavoriteResponseDto;
import com.leekm.board.entity.BoardEntity;
import com.leekm.board.entity.BoardViewEntity;
import com.leekm.board.entity.CommentEntity;
import com.leekm.board.entity.FavoriteEntity;
import com.leekm.board.entity.SearchLogEntity;
import com.leekm.board.entity.UserEntity;
import com.leekm.board.entity.resultSet.BoardListResultSet;
import com.leekm.board.entity.resultSet.CommentListResultSet;
import com.leekm.board.repository.BoardRepository;
import com.leekm.board.repository.BoardViewRepository;
import com.leekm.board.repository.CommentRepository;
import com.leekm.board.repository.FavoriteRepository;
import com.leekm.board.repository.SearchLogRepository;
import com.leekm.board.repository.UserRepository;
import com.leekm.board.service.BoardService;
